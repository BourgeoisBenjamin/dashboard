                    ...
                    <div className="element">
                        ...
                        <div className="second-column">
                            ...
                            <div className="username-input">
                                <FormControl fullWidth variant="outlined">
                                    ...
                                    <OutlinedInput
                                        id="outlined-adornment-amount"
                                        startAdornment={<InputAdornment
                                            position="start"><PersonOutlineIcon/></InputAdornment>}
                                        labelWidth={100}
                            ...
                            <div className="update-button">
                                <button onClick={this.onClickUpdateInfo}
                                        disabled={this.state.sendingUpdateInfo}>Update
                                </button>
                            </div>
                            <div className="loader"
                                 style={{display: (this.state.sendingUpdateInfo ? 'block' : 'none')}}>
                                <ClipLoader size="50"/>
                            </div>
                        </div>
                    </div>
